// This file is generated via taurpc. See src-tauri/src/lib.rs for the source definitions.
// Manual edits may be overwritten if the build pipeline regenerates the bindings.
...
export type ClaudeVoiceRequest = {
        api_key: string
        audio_base64: string
...
export type ClaudeVoiceResponse = {
        answer_text: string
...
const ARGS_MAP = {
        '':
                '{"ask_claude":["request"],"ask_claude_voice":["request"],"collect_claude_metrics":["request"],"generate_livekit_token":["request"],"push_claude_metrics":["request"]}',
}
